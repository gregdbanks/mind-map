...
- [MANUAL] Visit the site — landing page shows with hero, features, and "Get Started" button
- [MANUAL] Click "Get Started" — navigates to signup
- [MANUAL] Click the ThoughtNet logo in the landing header — stays on landing page
...
- [MANUAL] Log back in — returns to dashboard with your maps
...
- [MANUAL] "Templates" button opens modal with 6 templates to choose from
- [MANUAL] Select a template and click "Use Template" — new map opens pre-populated
- [MANUAL] Download a template JSON file from the template modal
- [MANUAL] Import a JSON file — new map appears on dashboard
- [MANUAL] Delete a map from dashboard — map removed, confirm it doesn't break anything else
- [MANUAL] "Library" link in header navigates to the public library
- [MANUAL] House ad banner appears for free users, can be dismissed with X
...
- [MANUAL] Change node color — color picker works, color persists

## Search
- [MANUAL] Open search (Ctrl/Cmd+F or search icon)
- [MANUAL] Type a node title — matching nodes appear in results
- [MANUAL] Type text that only exists in a node's notes — note match appears with snippet and file icon
- [MANUAL] Click a search result — canvas pans to that node and selects it
...
- [MANUAL] Export as PNG — image downloads with all visible nodes
- [MANUAL] Export as SVG — vector file downloads
- [MANUAL] Export as PDF — document downloads
- [MANUAL] Export as Markdown — text file with hierarchy preserved
...
- [MANUAL] Rate a map (1-5 stars) — rating registers, average updates
- [MANUAL] Change your rating — updates correctly
...
- [MANUAL] House ad banner shows below library filters for free users
...
- [MANUAL] Pro export features unlocked
